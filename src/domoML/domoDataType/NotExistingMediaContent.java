...
/**
 * Exception thrown when expected to find an Element and it's not found.
 */
public class NotExistingMediaContent extends Exception {

	/** Constructor without paramters. */
	public NotExistingMediaContent() {
		// do nothing.
	}
}
